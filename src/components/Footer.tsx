          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start">
                <svg className="w-5 h-5 text-facebook mr-3 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                </svg>
                <span>contact@alexhunt.com</span>
              </li>
              <li className="flex items-start">
                <svg className="w-5 h-5 text-facebook mr-3 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
...
const SocialLink = ({ href, icon }: SocialLinkProps) => {
  ...
  switch (icon) {
    case 'facebook':
      ...
      break;
    case 'instagram':
      bgColor = 'bg-gradient-to-tr from-instagram-purple via-instagram-pink to-instagram-orange';
      break;
    case 'twitter':
      bgColor = 'bg-[#1DA1F2]';
      break;
  ...
  return (
    <a href={href} target="_blank" rel="noreferrer" className={`${bgColor} text-white p-2 rounded-full hover:opacity-90 transition-opacity`}>
      {getIcon()}
    </a>
  );
};
